<h2>Use <a href="http://ph7builder.com">pH7Builder</a> on a non-Linux system</h2>

<p>Of course, you can also install <strong>pH7Builder</strong> on Mac and Windows!</p>
<p>All pH7Builder versions are compatible with Mac OS and from <em>pH7Builder 1.0.2</em> with Windows OS.</p>
