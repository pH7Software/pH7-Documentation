...
<p>
    Because of that, you will also have to to remove the "~/YOUR-PROTECTED-FOLDER/data/cache/pH7_cache/str/uri/" folder in order to take into account the new admin URL.<br />
