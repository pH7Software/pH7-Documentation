<h2>Edit Terms, Privacy, Legal Notice, About Us pages</h2>

<p>Go to your <a href="{site_url}en/how-to-go-to-admin-panel">Admin Panel</a> -> File/Page -> Page Module -> and look for the page name you want to edit.</p>
