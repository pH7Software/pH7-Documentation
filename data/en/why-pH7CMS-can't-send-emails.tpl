...
<p>Finally, we always recommend using <a href="http://ph7builder.com/doc/en/hosting" title="List of recommended Web Hosting for pH7CMS">a host recommended by us</a>.</p>
